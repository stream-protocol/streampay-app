...
@Component({
  selector: 'app-streampay-processor',
  templateUrl: './streampay-processor.component.html',
  styleUrls: ['./sstreampay-processor.component.scss'],
})
export class StreamPayProcessorComponent implements OnInit {
